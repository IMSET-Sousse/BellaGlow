...
if ($_SERVER['REQUEST_METHOD'] === 'POST') {
    ...
    $query = "INSERT INTO contact2 (name,email, password) VALUES ('$name',$email', '$password')";
...
if (isset($_GET['delete_id'])) {
    ...
    $delete_query = "DELETE FROM contact2 WHERE id = '$delete_id'";
           ...
           <th>
            ...
            <tbody>
                ...
                while ($row = mysqli_fetch_assoc($result)) {
                    ...
                    echo "<td>";
                    echo "<a href='edit_userr.php?id={$row['id']}' class='btn btn-warning btn-sm'>Edit</a>";
                    echo "<a href='userr.php?delete_id={$row['id']}' class='btn btn-danger btn-sm ml-1'>Delete</a>";
                    echo "</td>";
                    echo "</tr>";
                }
                ?>
