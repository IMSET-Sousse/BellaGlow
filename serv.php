...
if ($_SERVER['REQUEST_METHOD'] === 'POST') {
    ...
    $query = "INSERT INTO pack (img, titre, prix) VALUES ('$img', '$titre', '$prix')";
...
if (isset($_GET['delete_id'])) {
    ...
    $delete_query = "DELETE FROM pack WHERE id = '$delete_id'";
    mysqli_query($conn, $delete_query);
}

// Récupérer et afficher la liste des produits
$result = mysqli_query($conn, "SELECT * FROM pack");
?>
<!DOCTYPE html>
<html lang="en">
  <head>
            ...
            <th>
             ...
             <button type="submit" class="btn btn-danger">Add</button>
                ...
                while ($row = mysqli_fetch_assoc($result)) {
                    ...
                    echo "<td>{$row['prix']}</td>";
                    echo "<td>";
                    echo "<a href='edit_serv.php?id={$row['id']}' class='btn btn-warning btn-sm'>Edit</a>";
                    echo "<a href='serv.php?delete_id={$row['id']}' class='btn btn-danger btn-sm ml-1'>Delete</a>";
                    echo "</td>";
                    echo "</tr>";
                }
                ?>
